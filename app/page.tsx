...
<div className="mb-8 max-w-lg mx-auto bg-[#F4F6F8] rounded-lg p-4 border border-gray-200">
  ...
  <img src="scotiabank.png" alt="Scotiabank" className="h-30" />
  <img src="td.png" alt="TD Bank" className="h-30" />
  <img src="firstnational.png" alt="First National" className="h-30" />
  <img src="hometrust.png" alt="Home Trust" className="h-30" />
  <img src="rmg.png" alt="RMG Mortgages" className="h-30" />
</div>
