  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        setSubmitStatus({
          success: true,
          message: result.message || "Thank you for your inquiry! I'll get back to you within 2 hours.",
        })
        setFormData({
          name: "",
          email: "",
      ...
      setSubmitStatus({
        success: false,
        message: "There was an error sending your message. Please try again or call me directly at (604) 123-4567.",
      })
    } finally {
  ...
  return (
    <Card className="border-0 shadow-lg">
      <CardHeader>
        ...
        <CardDescription>Fill out the form below and I'll get back to you within 2 hours.</CardDescription>
      </CardHeader>
      <CardContent>
